...
public class EventLogsConstant {
     ...
     * 和日志相关
     */
    public static final String HBASE_TABLE_NAME = "logs";//表名
    public static final String HBASE_COLUMN_FAMILY = "info";//列簇
    public static final String EVENT_COLUMN_NAME_VERSION = "ver";//列...
